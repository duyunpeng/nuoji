...
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <li><a href="/role/pagination">角色管理</a></li>
    <li>角色查看</li>
</ul>
[/@override]
        ...
        <ul class="contract-show">
            ...
            <div>
                <div class="col-sm-offset-6 col-sm-12">
                    <a href="[@spring.url '/role/create' /]" class="btn btn-success">再创建一个</a>
                    <a href="[@spring.url '/role/pagination' /]" class="btn btn-default">返回列表</a>
                </div>
            </div>
        </ul>
    </div>
