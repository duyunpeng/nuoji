...
<div class="row margin-md">
    <a href="/role/create" class="btn btn-md btn-success">新增角色</a>
</div>
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/role/pagination?name=${command.name!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
