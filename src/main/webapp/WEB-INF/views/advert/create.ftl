[@override name="title"]Advert管理 - Advert创建[/@override]
...
<div class="row">
    <div class="col-lg-8">
        <form class="form-horizontal" action="/advert/create" method="post" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="url" name="url"
                           value="${command.url!}" placeholder="广告跳转路径"
            ...
            <div class="form-group hidden" id="content_item">
                <label for="content" class="col-md-3 control-label">内容*</label>
                <div class="col-md-9">
                    <input class="form-control" id="content" name="content"
                           value="${command.content!}" placeholder="内容"
                           data-parsley-required-messages="内容不能为空"
                           data-parsley-trigger="change"/>
...
//                alert(src);
        ...
        uploader.on('uploadSuccess', function (file, result) {
            ...
            var $ul = $(".img-box");
            $ul.empty();
            $ul.append('<li><img src=' + url + '/><input id="url" type="hidden" value=' + url + '  name="content_item"/><div><a href="#" class="btn btn-danger del-img">删除</a></div></li>');
            $("#content").val(url);
        });
    ...
    $("#select").on('change', function () {
        ...
        if (sel_val == "TEXT") {
            $("#pic").addClass("hidden");
            $("#content_item").removeClass("hidden");
        }
    })
</script>
[/@override]
