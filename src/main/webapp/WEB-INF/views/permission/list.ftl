...
<div class="row margin-md">
    <a href="/permission/create" class="btn btn-md btn-success">新增权限</a>
</div>
                        ...
                        <tbody>
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="[@spring.url '/permission/info/${permission.id!}'/]"
                                           data-toggle="tooltip" data-placement="top" title="点击查看详情">
                                            <span class="label label-info">查看</span>
                                        </a>
                                        <a href="[@spring.url '/permission/edit/${permission.id!}'/]"
