<header class="top-nav">
    <div class="top-nav-inner">
        <div class="nav-header">
                    ...
                    <ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
                        <li class="user-avatar">
                            ...
                            <div class="user-content">
                                ...
                                <div class="m-top-xs">
                                    <a href="[@spring.url '/account/profile'/]" class="m-right-sm">个人资料</a>
            ...
            <a href="/" class="brand">
                <img src="" alt=""/><span class="brand-name"> 后台管理</span>
            </a>
        </div>
                ...
                <div class="user-block hidden-xs">
                    ...
                    <div class="panel border dropdown-menu user-panel">
                        <div class="panel-body paddingTB-sm">
                            <ul>
                                <li>
                                    <a href="[@spring.url '/account/profile'/]">
                ...
                <ul class="nav-notification">
                    <li>
                        ...
                        <ul class="dropdown-menu message pull-right">
                            ...
                            <li><a href="[@spring.url '/messages/pagination'/]">查看所有邮件</a></li>
                        </ul>
                    </li>
                    <li>
